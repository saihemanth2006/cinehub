...
// Normalize whitespace in strings (collapse multiple spaces)
...
class _JobsPageState extends State<JobsPage> {
  ...
  Future<void> _fetchJobs() async {
    ...
    try {
      final jobsList = await _jobsSvc.fetchJobs();
      setState(() {
        _jobs = jobsList.map((j) {
          ...
          switch (j['category']) {
            case 'Acting':
              c1 = const Color(0xFF7B5CFF);
              c2 = const Color(0xFF3A1FA0);
              icon = Icons.theater_comedy_rounded;
              break;
            case 'Cinematography':
              c1 = const Color(0xFF00BFA5);
              c2 = const Color(0xFF004D40);
              icon = Icons.camera_rounded;
              break;
            case 'Writing':
              c1 = const Color(0xFFFF3D6B);
              c2 = const Color(0xFF8B0024);
              icon = Icons.edit_note_rounded;
              break;
            case 'Direction':
              c1 = const Color(0xFFFFA726);
              c2 = const Color(0xFF6D3400);
              icon = Icons.movie_filter_rounded;
              break;
            case 'VFX':
              c1 = const Color(0xFF00D4FF);
              c2 = const Color(0xFF003356);
              icon = Icons.auto_fix_high_rounded;
              break;
            case 'Editing':
              c1 = const Color(0xFF7C3AED);
              c2 = const Color(0xFF2E1065);
              icon = Icons.cut_rounded;
              break;
            case 'Production':
              c1 = const Color(0xFFBE185D);
              c2 = const Color(0xFF500724);
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Row(children: [
                            Flexible(
                              child: Text(normalizeString(j['title'] as String),
                          ...
                          Text(normalizeString(j['company'] as String),
                              style: TextStyle(
                                  color: c1,
                                  fontSize: 12,
                ...
                Wrap(
                  ...
                  children: [
                    _Tag(
                        ...
                        label: normalizeString(j['location'] as String),
                        color: _textSec),
                    _Tag(
                        icon: Icons.schedule_rounded,
                        label: normalizeString(j['type'] as String),
                        color: c1),
                    _Tag(
                        icon: Icons.currency_rupee_rounded,
                        label: normalizeString(j['pay'] as String),
                        color: _textSec),
                  ],
                ),
